...
export default function HeroLayout1(props) {
  ...
  const buttonOnClick = useNavigateAction({
    type: "url",
    url: "https://smartchallenges.asu.edu/",
  });
  return (
    <Flex
      gap="0"
      ...
      >
        ...
        >
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children="ASU Smart City Cloud Innovation Center"
          ...
          >
            ...
            <Text
              ...
              padding="0px 0px 0px 0px"
              whiteSpace="pre-wrap"
              children="Visit our website to learn more about what we do and Submit a challenge you believe will build smarter communities in the Phoenix metropolitan area by using digital cloud technology to solve pressing community and regional challenges."
              {...getOverrideProps(
                overrides,
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco."
              )}
