...
export declare type TableHeading2OverridesProps = {
    TableHeading2?: PrimitiveOverrideProps<FlexProps>;
...
export declare type TableHeading2Props = React.PropsWithChildren<Partial<FlexProps> & {
    cellStyle?: "Header";
} & {
    overrides?: TableHeading2OverridesProps | undefined | null;
}>;
export default function TableHeading2(props: TableHeading2Props): React.ReactElement;
